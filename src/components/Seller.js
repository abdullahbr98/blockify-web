    ...
    <div className='sellerDiv'>
      ...
      <div className="row">
        <div className="col-12 mt-5 text-center">
          <h1 className='headingTransaction'>Seller Homepage</h1>
        </div>
        <div className="col-12 text-center">
          <h4 className='mt-4 descriptionHeading'>Transaction with Manufacturer</h4>
        </div>
        <div className="col-12 text-center">
      ...
      <div className="col-4">
      <Input placeholder="Amount (ETH)" name="amount" type="number" handleChange={handleChange} className="text-field" />
      </div>
